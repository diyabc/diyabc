...
void ReftableC::bintotxt() {
    ...
    vector<string> ss;
    string nomfi=path+"reftable.txt";
    bool trouve,trouve2;cout<<"Ouverture de "<<this->filename<<"\n";
    fstream f0(this->filename.c_str(),ios::in|ios::binary);
    if (not f0) {
        f0.close();cout<<"Fermeture de "<<this->filename<<"\n";
        this->filename=path+"reftableRF.bin";cout<<"Ouverture de "<<this->filename<<"\n";
